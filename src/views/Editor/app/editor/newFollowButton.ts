...
// 导入自定义的跟随按钮组件
import FollowButtonVue from '@/components/followButton/followButton.vue';
...
export class FollowButton extends Disposable {
    ...
    private createComponentContainer(elementType: string = 'default', objectId: string = ''): void {
        ...
        container.id = 'follow-button-vue-container';
        ...
        // 创建Vue应用并挂载组件
        this.followButtonApp = createApp(FollowButtonVue);
